...
class Transportation:
    def __init__(self, speed, description, obstacles):
        self.speed = speed
...
class SBahn(Transportation):
    def __init__(self):
        self.name = "S-Bahn"
        self.speed = "fast"
        self.description = "The S-Bahn is a bit warm and clammy today, but you can read a book, listen to music and gaze out the window. 🚉"
...
class Bicycle(Transportation):
    def __init__(self):
        self.name = "bicycle"
        self.speed = "average"
        self.description = "Efficient, green and easy - cycling is an excellent choice! 🚲"
...
class Story:
    ...
    def end(self, character):
        print(
            f"Yay, {character.name}! You reached the lake by {character.transportation.name}. Time to go swim and spend the rest of the day snoozing in the sun ⛵"
        )
